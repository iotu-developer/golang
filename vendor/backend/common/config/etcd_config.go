...
var DefaultEtcdAddrs = []string{"http://etcdproxy.in.codoon.com:2381"}
...
// 设置etcd配置
func SetCfgToEtcd(addrs []string, service, cfg string) error {
	...
	_, err = api.Set(context.Background(), etcdKey(service, environment), cfg,nil)
	return err
}
